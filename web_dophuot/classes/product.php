...
<?php 
	...
	*/
	class product
	{
		...
		public function getLastestLeu()
		{
			$query = "SELECT * FROM tbl_product where brandId = '15' order by productId = '26' desc limit 1";
			$result = $this->db->select($query);
			return $result;	
		}
		public function getLastestMubh()
		{
			$query = "SELECT * FROM tbl_product where brandId = '22' order by productId = '28' desc limit 1";
			$result = $this->db->select($query);
			return $result;	
		}
		public function getLastestXeng()
		{
			$query = "SELECT * FROM tbl_product where brandId = '15' order by productId = '34' desc limit 1";
			$result = $this->db->select($query);
			return $result;	
		}
		public function getLastestBalo()
		{
			$query = "SELECT * FROM tbl_product where brandId = '15' order by productId = '33' desc limit 1";
			$result = $this->db->select($query);
			return $result;	
		}
